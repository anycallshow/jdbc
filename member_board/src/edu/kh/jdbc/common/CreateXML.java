...
public class CreateXML { // 혼자서 실행하면 파일 사라집니다 주의 !! 
	...
	// 			자바에서 XML 파일을 잃어오는 코드는 변하지 않음 -> 컴파일X -> 시간 효울 상승
	public static void main(String[] args) {
		
		// XMK은 K : V 형식 map, XML은 문자열만 저장
		
		// Map<String, String> == properties 
		
		// * Properties 컬렉션 객체*
		// 1. <String, String>으로 Key, Value가 타입제한된 Map
		...
		try {
			...
			prop.storeToXML(fos, "board Service SQL"); // xml파일을 생성
