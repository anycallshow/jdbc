...
public class JDBCExample1 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Class.forName("oracle.jdbc.driver.OracleDriver"); // 안적어도 자동으로 사용됨
			// ClassNotFoundException 발생 가능성이 있음.
			
			// 2. 연결 정보를 담은 Connection을 생성 (통로 생성)
			...
			// 3. Statement객체에 적재할 SQL 작성하기 (셔틀버스에 질문작성)
			...
			while(rs.next()) {
				...
				// [Type]은 DB에서 얻어와 Java에 저장할 자료형(Java쪽 자료형)
